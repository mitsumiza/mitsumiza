                ...
                <div class="form-group">
                    ...
                    <select class="form-control" id="type" name="type">
                        ...
                        <?php foreach ($categories as $category): ?>
                            <option value="<?php echo $category; ?>" <?php if(isset($_GET['type']) && $_GET['type'] == $category) echo 'selected'; ?>><?php echo $category; ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
            </div>
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <div class="input-group">
                        <input type="number" class="form-control" id="price_min" name="price_min" placeholder="От" value="<?php echo isset($_GET['price_min']) ? $_GET['price_min'] : ''; ?>">
        ...
        <div class="row">
            ...
            while($row = $result->fetch_assoc()) {
                ...
                <div class='col-md-4 mb-4'>
                    <div class='card'>
                        <img src='catalog_images/$image_name' class='card-img-top' alt='$row[name]'>
                        <div class='card-body'>
                            <h5 class='card-title'>$row[name]</h5>
                            <p class='card-text'>$row[description]</p>
                            <p class='card-text'>Тип: $row[type_name]</p>
