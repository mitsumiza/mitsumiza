                    ...
                    <form action="signup.php" method="POST">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <select name="blood_group" class="form-control" required>
                                ...
                                <option value="O" <?= $blood_group == '1' ? 'selected' : '' ?>>1</option>
                                <option value="A" <?= $blood_group == '2' ? 'selected' : '' ?>>2</option>
                                <option value="B" <?= $blood_group == '3' ? 'selected' : '' ?>>3</option>
                                <option value="AB" <?= $blood_group == '4' ? 'selected' : '' ?>>4</option>
                            </select>
                        </div>
                        <div class="form-group mb-3">
