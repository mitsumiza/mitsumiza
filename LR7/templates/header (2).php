...
<?php
require_once '../templates/header.php'; // Подключаем  modules.php
?> 
<!DOCTYPE html>
<html lang="en">
<head>
      ...
      <div class="container"> 
        <ul class="nav justify-content-start"> 
          <li class="nav-item d-flex align-items-center"> 
            <img src="../image/img/logo.jpg" alt="Логотип" class="me-2"> 
              ...
              <div class="container-fluid">
                  ...
                  <div class="collapse navbar-collapse" id="navbarNav">
                      ...
                      <ul class="navbar-nav"> 
                        ...
                        <li class="nav-item">
                          <img src="../image/img/bag.jpg" alt="Корзина" class="icons"> 
                      </li>
                      <li class="nav-item">
                        <img src="../image/img/heart.jpg" alt="Корзина" class="icons"> 
                    </li>
                      <li class="nav-item">
                        <img src="../image/img/zoom.jpg" alt="Корзина" class="icons"> 
                    </li>
                      </ul> 
                  </div>
              </div>
