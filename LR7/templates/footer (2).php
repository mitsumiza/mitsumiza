        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card h-100">
                    <img src="../image/img/icon1.jpg" alt="Иконка 1" class="card-img-top">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <img src="../image/img/icon2.jpg" alt="Иконка 2" class="card-img-top">
                    <div class="card-body">
            ...
            <div class="col-md-4">
                <div class="card h-100">
                    <img src="../image/img/icon3.jpg" alt="Иконка 3" class="card-img-top">
                    <div class="card-body">
        ...
        <table>
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td></td>
                    <td>
                        <img src="../image/img/vk.jpg" alt="" class="social-media-icon">
                        <img src="../image/img/youtube.jpg" alt="YouTube" class="social-media-icon">
                        <img src="../image/img/music.jpg" alt="Музыка" class="social-media-icon">
                        <img src="../image/img/tg.jpg" alt="Telegram" class="social-media-icon">
                    </td>
                </tr>
                <tr>
        ...
        <div class="container">
            <div class="row align-items-center">
                ...
                <div class="col-md-2 text-center">
                    <img src="../image/img/rating.jpg" alt="Рейтинг" class="img-fluid">
                </div>
                <div class="col-md-2 text-center">
                    <img src="../image/img/lebedev-logo.jpg.jpg" alt="Логотип Lebedev Studio" class="img-fluid">
                </div>
                <div class="col-md-3"></div>
            </div>
        </div>
