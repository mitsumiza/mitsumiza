...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css" integrity="sha384-xOolHFLEh07PJGoPkLv1IbcEPTNtaed2xpHsD9ESMNYq5MTevH+c/gtt/9J+mc/rF4" crossorigin="anonymous">
...
<body>
    ...
    <div class="container mt-3">
        <form action="tourism.php" method="get">
            <div class="row">
                <div class="col-md-4">
                    <div class="form-group">
                        <label for="search_name">Название товара:</label>
                        <input type="text" class="form-control" id="search_name" name="name" placeholder="Введите название товара" value="<?php echo isset($_GET['name']) ? $_GET['name'] : ''; ?>">
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="form-group">
                ...
                <div class="col-md-4">
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            <input type="number" class="form-control" id="price" name="price_min" placeholder="От" value="<?php echo isset($_GET['price_min']) ? $_GET['price_min'] : ''; ?>">
                            <div class="input-group-append">
                                <input type="number" class="form-control" name="price_max" placeholder="До" value="<?php echo isset($_GET['price_max']) ? $_GET['price_max'] : ''; ?>">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                while($row = $result->fetch_assoc()) {
                    ...
                    <div class='col-md-4 mb-4'>
                        <div class='card'>
                            <img src='inc/catalog_images/$row[img_path]' class='card-img-top' alt='$row[name]'>
                            <div class='card-body'>
